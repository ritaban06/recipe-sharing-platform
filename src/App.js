        ...
        <nav className="bg-white shadow-md">
          ...
          <div className={`sm:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
            <div className="pt-2 pb-3 space-y-1">
              <Link to="/" className="text-gray-500 hover:text-gray-700 block px-3 py-2 text-base font-medium">
                <HomeIcon className="h-5 w-5 inline mr-1" />
                Home
              </Link>
              <Link to="/recipes" className="text-gray-500 hover:text-gray-700 block px-3 py-2 text-base font-medium">
                <BookOpenIcon className="h-5 w-5 inline mr-1" />
                Recipes
              </Link>
              <Link to="/submit" className="text-gray-500 hover:text-gray-700 block px-3 py-2 text-base font-medium">
                <PlusCircleIcon className="h-5 w-5 inline mr-1" />
                Submit Recipe
              </Link>
              <Link to="/search" className="text-gray-500 hover:text-gray-700 block px-3 py-2 text-base font-medium">
              ...
              <Link to="/login" className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded block mx-3 my-2">
                Log In
              </Link>
            </div>
          </div>
